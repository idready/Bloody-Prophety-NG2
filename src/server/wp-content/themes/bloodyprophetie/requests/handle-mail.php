...
<?php
    ...
    if(count($errors)) {
        ...
        if( mail($to, $subject, $body, $headers) ) {
            ...
            echo json_encode ( array('errors' => false, 'valid' => true, 'message' => 'Votre message à bien été envoyé, merci.') );
        } else {
            echo json_encode ( array('errors' => true, 'valid' => false, 'message' => 'Erreur serveur lors de l\'envoi du mail.') );
        }
